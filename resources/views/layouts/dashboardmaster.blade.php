            ...
            <div class="header-wrapper m-0">
                <div class="header-logo-wrapper p-0">
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo" src="{{ asset('dashboard_assets') }}/images/logo/1.png" alt="logo">
                            <img class="img-fluid white-logo" src="{{ asset('dashboard_assets') }}/images/logo/1-white.png" alt="logo">
                        </a>
                    </div>
                    <div class="toggle-sidebar">
                        <i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i>
                        <a href="index.html">
                            <img src="{{ asset('dashboard_assets') }}/images/logo/1.png" class="img-fluid" alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown">
                            <div class="notification-box">
                                <a href="{{ route("index") }}" target="_blanck" class="btn btn-info">visit site</a>
                            </div>
                        </li>
                        <li class="onhover-dropdown">
                            <div class="notification-box">
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            <div class="media profile-media">
                                @if (auth()->user()->profile_photo)
                                    <img class="user-profile rounded-circle" src="{{ asset('uploads/profile_photos') }}/{{ auth()->user()->profile_photo }}" alt="not found"/>
                                @else
                                ...
                                <div class="user-name-hide media-body">
                                    ...
                                    <p class="mb-0 font-roboto">{{ auth()->user()->email }}<i class="middle ri-arrow-down-s-line"></i></p>
                                </div>
                            </div>
                ...
                <div>
                    <div class="logo-wrapper logo-wrapper-center">
                        <a href="index.html" data-bs-original-title="" title="">
                            <img class="img-fluid for-white" src="{{ asset('dashboard_assets') }}/images/logo/full-white.png" alt="logo">
                        </a>
                        <div class="back-btn">
                    ...
                    <div class="logo-icon-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo main-white" src="{{ asset('dashboard_assets') }}/images/logo/logo.png" alt="logo">
                            <img class="img-fluid main-logo main-dark" src="{{ asset('dashboard_assets') }}/images/logo/logo-white.png"
                                alt="logo">
                        </a>
                    </div>
