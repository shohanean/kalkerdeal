                                        ...
                                        @foreach ($featured_photos as $featured_photo)
                                            <div>
                                                <div class="sidebar-image">
                                                    <img src="{{ asset('uploads/product_featured_photos') }}/{{ $featured_photo->featured_photo_name }}" class="img-fluid blur-up lazyload" alt="not found">
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="right-box-contain">
                            ...
                            <div class="product-packege ">
                                ...
                                <select id="size_dropdown" name="" class="form-control">
                                    ...
                                    @foreach ($inventories->unique('size_id') as $inventory)
                                        <option value="{{ $inventory->relationshiptosize->id }}">{{ $inventory->relationshiptosize->name }}</option>
                                    @endforeach
                                </select>
                                <div class="product-title">
                                    <h4>Color</h4>
                            ...
                            <div class="note-box product-packege">
                                ...
                                @auth
                                    <button id="add_to_cart_btn" class="btn btn-md bg-dark cart-button text-white w-100 d-none">
                                        Add To Cart
                                    </button>
                                @else
                                    <button class="btn btn-md bg-danger cart-button text-white w-100" data-bs-toggle="modal" data-bs-target="#loginModal">
                                        Login First
                                    </button>
                                @endauth
                            ...
                            <div class="pickup-box">
                                ...
                                <div class="product-info">
                                    <ul class="product-info-list product-info-list-2">
                                        <li>Category : <a href="javascript:void(0)">{{ $product->relationshipwithcategory->name }}</a></li>
                                        <li>Selling Since : <a href="javascript:void(0)">{{ $product->created_at->format('M d, Y') }}</a></li>
                                        <li>Stock : <a href="javascript:void(0)">{{ $inventories->sum('quantity') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                                                    ...
                                                    <ul class="review-list">
                                                        ...
                                                        <li>
                                                            <div class="people-box">
                                                                <div>
                                                                    <div class="people-image">
                                                                        <img src="{{ asset('frontend_assets') }}/assets/images/review/2.jpg"
                                                                            class="img-fluid blur-up lazyload"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <div class="people-box">
                                                                <div>
                                                                    <div class="people-image">
                                                                        <img src="{{ asset('frontend_assets') }}/assets/images/review/3.jpg"
                                                                            class="img-fluid blur-up lazyload"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                ...
                <div class="right-sidebar-box">
                    <div class="vendor-box">
                        <div class="verndor-contain">
                            <div class="vendor-image">
                                <img src="{{ asset('uploads/profile_photos') }}/{{ $vendor->profile_photo }}" class="blur-up lazyload" alt="not found">
                            </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="address-contact">
                                        ...
                                        <h5>Member Since: <span class="text-content">{{ $vendor->created_at->format('d M, Y') }}</span></h5>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="ratio_156 pt-25">
                        <div class="home-contain">
                            <img src="{{ asset('frontend_assets') }}/assets/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload"
                                alt="">
                            ...
                            <div class="product-box-3 wow fadeInUp">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left.htm">
                                            <img src="{{ asset('uploads/product_thumbnails') }}/{{ $related_product->product_thumbnail }}" class="img-fluid blur-up lazyload" alt="">
                                        </a>
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        ...
                                        <h5 class="price"><span class="theme-color">{{ $related_product->discounted_price }}</span>
                                            @if ($related_product->discount > 0)
                                                <del>{{ $related_product->regular_price }}</del>
                                            @endif
                                        </h5>
                                        <div class="add-to-cart-box bg-white">
                                            <a href="{{ route('product.details', $related_product->id) }}" class="btn btn-add-cart addcart-button">
                                                Details
                                            </a>
                                        </div>
                                    </div>
    ...
    $(document).ready(function(){
        ...
        $('#add_to_cart_btn').click(function(){
            ...
            $.ajax({
                type: 'POST',
                url: '/add/to/cart',
                data: {user_quantity:user_quantity, d_size_id:d_size_id, d_color_id:d_color_id, d_product_id:d_product_id},
                success: function (data) {
                    if(data == 'success'){
                        location.reload();
                    }else{
