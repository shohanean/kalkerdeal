                    ...
                    <div class="dashboard-left-sidebar">
                        ...
                        <div class="profile-box">
                            <div class="cover-image">
                                <img src="{{ asset('frontend_assets') }}/assets/images/inner-page/cover-img.jpg"
                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/vendor-page/logo.png"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="row g-sm-4 g-3">
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/svg/order.svg"
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/svg/pending.svg"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/svg/pending.svg"
                                                        class="blur-up lazyload" alt="">
                                                    <div class="totle-detail">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/svg/wishlist.svg"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/svg/wishlist.svg"
                                                        class="blur-up lazyload" alt="">
                                                    <div class="totle-detail">
                                    ...
                                    <div class="table-responsive dashboard-bg-box">
                                        <table class="table product-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="product-image">
                                                        <img src="{{ asset('frontend_assets') }}/assets/images/vegetable/product/6.png"
                                                            class="img-fluid" alt="">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td class="product-image">
                                                        <img src="{{ asset('frontend_assets') }}/assets/images/vegetable/product/7.png"
                                                            class="img-fluid" alt="">
                                                    </td>
                                                    <td>
                            ...
                            <div class="tab-pane fade" id="pills-order" role="tabpanel"
                                ...
                                <div class="dashboard-order">
                                    <div class="title">
                                        <h2>All Order ({{ $invoices->count() }})</h2>
                                                ...
                                                <tbody>
                                                    @foreach ($invoices as $invoice)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label
                                                                    class="success">{{ $invoice->payment_status }}</label>
                                                            </td>
                                                            <td>
                                                                <h6>{{ $invoice->total }}</h6>
                                                            </td>
                                                            <td>
                                                                <a href="{{ route('invoice.download', $invoice->id) }}"
                                                                    class="bg-success btn btn-sm">Details (PDF)</a>
                                                                @if ($invoice->payment_status == 'paid')
                                                                    <br>
                                                                    <a href="{{ route('customer.review', $invoice->id) }}"
                                                                        class="bg-info btn btn-sm">Give Review</a>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    @endforeach
